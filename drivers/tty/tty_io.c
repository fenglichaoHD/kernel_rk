				   ...
				   const struct attribute_group **attr_grp)
{
	...
	dev->release = tty_device_create_release;
       ...
       if(!strcmp(name, "ttyUSB10")){
                sprintf(name, "%s", "ttyS10");
       }else if(!strcmp(name, "ttyUSB11")){
               sprintf(name, "%s", "ttyS11");
       }else if(!strcmp(name, "ttyUSB12")){
               sprintf(name, "%s", "ttyS12");
       }else if(!strcmp(name, "ttyUSB13")){
               sprintf(name, "%s", "ttyS13");
       }
